...
return [
    ...
    'table' => [
        ...
        'actions' => [
            ...
            'clear_file' => [
                'label' => 'Limpar ficheiro',
                'modal_heading' => 'Limpar :file',
                'modal_description' => 'Tem a certeza de que pretende limpar o log :file?',
                'success' => ':file foi limpo!',
            ],
            'copy_markdown' => [
                'label' => 'Copiar como Markdown',
                'success' => 'Markdown copiado para a área de transferência',
                'headers' => [
                    'file' => 'Ficheiro',
                    'message' => 'Mensagem',
                    'description' => 'Descrição',
                    'context' => 'Contexto',
                    'stack_trace' => 'Rastreio da pilha',
                    'mail' => 'Detalhes do e-mail',
                ],
            ],
        ],
    ],
