...
return [
    ...
    'table' => [
        ...
        'actions' => [
            ...
            'clear_file' => [
                'label' => 'Vider le fichier',
                'modal_heading' => 'Vider :file',
                'modal_description' => 'Voulez-vous vraiment vider le journal :file ?',
                'success' => ':file a été vidé !',
            ],
            'copy_markdown' => [
                'label' => 'Copier en Markdown',
                'success' => 'Markdown copié dans le presse-papiers',
                'headers' => [
                    'file' => 'Fichier',
                    'message' => 'Message',
