...
return [
    ...
    'table' => [
        ...
        'actions' => [
            ...
            'clear_file' => [
                'label' => 'Vaciar archivo',
                'modal_heading' => 'Vaciar :file',
                'modal_description' => '¿Seguro que quieres vaciar el log de :file?',
                'success' => '¡:file ha sido vaciado!',
            ],
            'copy_markdown' => [
                'label' => 'Copiar como Markdown',
                'success' => 'Markdown copiado al portapapeles',
                'headers' => [
                    'file' => 'Archivo',
                    'message' => 'Mensaje',
